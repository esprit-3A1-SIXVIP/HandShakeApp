...
public class ArticleAdminController implements Initializable {
  ...
  private void charger(ActionEvent event) {
    ...
    try {
      ...
      Logger.getLogger(ArticleAdminController.class.getName()).log(Level.SEVERE, (String)null, ex);
    } 
  ...
  private void retour(MouseEvent event) {
    try {
      FXMLLoader top = new FXMLLoader(getClass().getResource("gestionnaire.fxml"));
  ...
  private void delete(MouseEvent event) {
    ...
    FXMLLoader top = new FXMLLoader(getClass().getResource("articleAdmin.fxml"));
    Parent root1 = null;
    try {
    ...
    ArticleAdminController dpc = top.<ArticleAdminController>getController();
    this.p1.getScene().setRoot(root1);
  }
  ...
  private void mkpdf() {
    ...
    try {
      ...
      Logger.getLogger(ArticleAdminController.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ex);
    } 
  }
  ...
  private void affart(MouseEvent event) {
    ...
    @FXML
    private void rott(MouseEvent event) {
          Timeline rotate = new Timeline();
      DoubleProperty r = this.imgrot.rotateProperty();
      rotate.getKeyFrames().addAll(new KeyFrame[] { new KeyFrame(new Duration(0), new KeyValue[] { new KeyValue(r, 
                  Integer.valueOf(0)) }), new KeyFrame(new Duration(23000.0D), new KeyValue[] { new KeyValue(r, 
